...
class TestH3ToolkitShow:
    ...
    def test_show_with_result_data(self):
        ...
        # Set up result data
        toolkit.result = pl.DataFrame({"hex_id": ["8c4ba0a4e15ffff", "8c4ba0a4e14ffff"], "value": [10.5, 20.3]})
    ...
    def test_show_with_custom_parameters(self):
        ...
        result = toolkit.show("value", classifier="Quantiles", k=3, cmap="viridis")
    ...
    def test_show_save_html(self, tmp_path):
        ...
        toolkit = H3Toolkit()
        toolkit.result = pl.DataFrame({"hex_id": ["8c4ba0a4e15ffff"], "value": [10.5]})
